...
func TestRemoteSelfProtectedTargetIsBlocked(t *testing.T) {
	...
	actions := []string{"docker_stop", "docker_kill", "docker_remove", "delete_vm", "shutdown", "reboot", "reset", "terraform_destroy", "k8s_deployment_scale", "k8s_deployment_delete", "proxmox_resize", "proxmox_config_update", "proxmox_migrate"}
